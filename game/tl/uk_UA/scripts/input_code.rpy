...
translate uk_UA code_65b679a4:

    # "Code accepted!"
    "Код прийнято!"

# game/scripts/input_code.rpy:29
translate uk_UA code_e2fb5461:

    # "Cheats now available in the pause menu."
    "Чити тепер доступні в меню паузи."
...
translate uk_UA code_eb50db30:

    # "Your name is now set to [name]."
    "Ваше ім'я тепер [name]."

# game/scripts/input_code.rpy:46
translate uk_UA code_65b679a4_2:
...
translate uk_UA code_81069967:

    # "Violet has left the Harem Hotel!"
    "Вайолет покинула Harem Hotel!"
...
translate uk_UA code_6afa7f1b:

    # "Day was successfully set to [day]!"
    "День успішно встановлено на [day]!"
...
translate uk_UA code_91c58a44:
    ...
    r "Код прийнято! Статистику Лін було підвищено."
...
translate uk_UA code_baead254_2:
...
translate uk_UA code_56b26835:
    ...
    "Нія тепер на невільничому шляху!"
...
translate uk_UA code_0ee331f2:
    ...
    "Сильвія тепер на шляху кохання!"
...
translate uk_UA code_bd85f266:
    ...
    "Сильвія тепер на невільничому шляху!"

# game/scripts/input_code.rpy:816
translate uk_UA code_94529849:
